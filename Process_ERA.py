...
fname = '/Users/shaymaalali/Desktop/Python_Codes/adaptor.mars.internal-1700077203.6175785-27016-4-a18dd8da-2a2a-4ca6-9381-9ecf793c76ea.nc'
ds = xr.open_dataset(fname)
...
for i in range(len(era_atmo_time)):
    ...
    if i == 0:
        ...
        era_waves_ustar = np.append(
            era_waves_ustar, np.atleast_3d(tmp2), axis=2)
